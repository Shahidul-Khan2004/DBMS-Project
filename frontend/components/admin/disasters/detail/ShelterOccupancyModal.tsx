...
import { postShelterOccupancy } from "@/lib/disaster-operations-api";
import type { DisasterShelterActivation } from "@/types/disaster-operations";

type ShelterOccupancyModalProps = {
  open: boolean;
...
export function ShelterOccupancyModal({
  open,
  disasterPublicUuid,
  shelter,
  onClose,
  onSuccess,
}: ShelterOccupancyModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      ...
      >
        ...
        <div className="space-y-4 px-5 py-4">
          <div>
            <FieldLabel htmlFor="people-count" required>
              People count
            </FieldLabel>
            <input
              id="people-count"
