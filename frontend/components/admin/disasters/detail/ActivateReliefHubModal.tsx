    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      ...
      >
        <div className="border-b border-slate-100 px-5 py-4">
          <h2 className="text-lg font-semibold text-slate-900">Manual relief hub override</h2>
          <p className="mt-2 text-sm font-medium text-slate-900">{facilityLabel}</p>
        </div>
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-4">
          <div>
            <FieldLabel htmlFor="hub-override-note" required>
            ...
            <textarea
              ...
              placeholder="Explain why this relief hub must be activated despite being outside affected areas."
