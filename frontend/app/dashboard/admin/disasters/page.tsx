...
import { DisastersWorkspace } from "@/components/admin/disasters/DisastersWorkspace";
...
function DisastersPageContent() {
  ...
  if (isChecking) {
    return <PageLoading label="Loading disasters" />;
  }
...
export default function AdminDisastersPage() {
  return (
    <Suspense fallback={<PageLoading label="Loading disasters" />}>
      <DisastersPageContent />
    </Suspense>
  );
}
