...
import { DisasterCommandOverviewWorkspace } from "@/components/dispatcher/disasters/DisasterCommandOverviewWorkspace";
...
export default function DispatcherDisasterOverviewPage() {
  ...
  return (
    ...
    >
      <DispatcherOpsShell className="flex min-h-0 flex-1 flex-col lg:overflow-hidden lg:min-h-0 lg:py-2">
        <DisasterCommandOverviewWorkspace
