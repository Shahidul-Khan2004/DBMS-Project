-- NIERS Full Schema Init (single file)
-- Combined from docker-init/*.sql in dependency order
-- (07_reports before 07b; matches intended init sequence)
-- Generated: 2026-06-13T17:44:25Z


-- =============================================================================
-- Source: docker-init/00_preamble.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/01_drop_views.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/02_drop_triggers.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/03_drop_tables.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/04_foreign_keys_on.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/05_identity_rbac.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/06_geography_and_service_zones.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/07_reports_intake_999.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/07b_intake_verification_reporter_actions.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/08_service_cases.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/09_agencies_and_units.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/10_emergency_incidents.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/11_dispatch_and_response.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/12_operator_workload.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/13_disaster_management.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/14_facilities_healthcare.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/15_relief.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/16_blood_support.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/17_notifications_and_email.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/18_audit.sql
-- =============================================================================
...
CREATE TABLE audit_logs (
    ...
    related_disaster_event_id BIGINT UNSIGNED NULL,
    ...
    KEY idx_audit_related_disaster (related_disaster_event_id),
...
-- =============================================================================
-- Source: docker-init/19_triggers.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/20_views.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/21_seed_reference_data.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/22_seed_administrative_areas.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/23_seed_notification_templates.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/24_seed_agencies_units_demo.sql
-- =============================================================================
...
(
  ...
  23.810300,
  90.412500,
  ST_SRID(POINT(90.412500, 23.810300), 4326),
...
(
  ...
  23.746100,
  90.374200,
  ST_SRID(POINT(90.374200, 23.746100), 4326),
...
(
  ...
  23.778900,
  90.397500,
  ST_SRID(POINT(90.397500, 23.778900), 4326),
...
INNER JOIN locations l ON l.public_uuid = v.location_uuid;
...
INNER JOIN unit_statuses us ON us.status_code = v.status_code;


-- =============================================================================
-- Source: docker-init/25_seed_agency_reps_demo.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/26_seed_agency_rep_demo_incidents.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/27_alter_agency_memberships_public_uuid.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/28_seed_disaster_demo_master.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/29_seed_citizen_reporting_demo.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/30_seed_pre_disaster_operations_demo.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/31_seed_case_messages_notifications_demo.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/32_seed_reporter_risk_demo.sql
-- =============================================================================
...
-- =============================================================================
-- Source: docker-init/33_seed_storyline_demo.sql
-- =============================================================================
