...
export const revokeResponsibility = disasterRepo.revokeResponsibility;
...
export const assignReliefHubManagingAgency = disasterRepo.assignReliefHubManagingAgency;
export const deactivateShelterActivation = disasterRepo.deactivateShelterActivation;
export const deactivateReliefHubActivation = disasterRepo.deactivateReliefHubActivation;
